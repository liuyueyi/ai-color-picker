<template>
  <view class="container">
    ...
    <view class="navbar">
      ...
      <view class="navbar-title">Color</view>
      <view class="navbar-right">
        <uni-icons type="color" size="20" color="#fff" />
        <uni-icons type="share" size="20" color="#fff" style="margin-left: 15px;" />
        <uni-icons type="file" size="20" color="#fff" style="margin-left: 15px;" />
      </view>
    </view>
